...
const Header = () => {
    ...
    const { closeSubmenu, totalAmount} = useGlobalContext();
    ...
    return ( 
        <header className="header" onMouseOver={handleSubmenu}>
            <Link to="/">
            <svg  className="header-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="hsl(120, 35%, 40%)" >
            ...
            <div className="nav-btns">
                <Link to="/favorite"><button className="fav-btn"><FaHeart /></button></Link>
                ...
                className="nav-btn">
                    {sidebarOpen ? <FaTimes /> : <FaBars />}</button>
            </div>
